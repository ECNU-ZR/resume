...
\begin{itemize}
  \item Used Negemax search and alpha–beta pruning
...
\begin{itemize}
  \item Used multithreading and socket for the basic implementation
...
\begin{itemize}[parsep=0.5ex]
  \item ITLTS
  \item Listening: 7.0 Reading: 7.0 Writing: 5.5 Speaking: 5.5 Overall: 6.5
\end{itemize}
