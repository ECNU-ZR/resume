...
\datedsubsection{\textbf{Fault-tolerant Key/Value Service}}\role{Golang}{Individual Project}{Mar. 2019 -- May. 2019}
...
\begin{itemize}
  \item Use Q-Learning to solve the deceptive path-planning problem
\end{itemize}
...
\begin{itemize}
  ...
  \item \texttt{Label Accuracy} $69.7\%$, \texttt{Sentence Selection F1} $71.1\%$
\end{itemize}
