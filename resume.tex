...
Brief introduction: A fault-tolerant Key/Value service base on the Raft algorithm
\begin{itemize}
...
Brief introduction: Use reinforcement learning to solve the deceptive path-planning problem
\begin{itemize}
  \item Used the idea of cost difference
  \item Used Q-Learning and divided training into two stages
\end{itemize}


\datedsubsection{\textbf{Automatic Fact Verification}}{Mar. 2019 -- May. 2019}
\role{Python}{Team Project}
Brief introduction: Verify a claim based on evidence selecting from corpus
\begin{itemize}
  \item Used the idea of cost differnce
  \item Used Q-Learning and divided training into two stages
\end{itemize}
...
\begin{itemize}
  \item Used Negamax search and alpha–beta pruning
  \item Used Iterative deepening search and manual pruning
  \item Also used MCTS to implement the AI
\end{itemize}
