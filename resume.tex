...
\textit{Master student} in Information Technology (IT) \qquad \ \textit{Weight. Average} 89/100
\datedsubsection{\textbf{East China Normal University (ECNU)}, Shanghai, China}{2013 -- 2017}
\textit{Bachelor student} in Computer Science and Technology (CS) \quad \textit{GPA} 3.54/4.0
...
\begin{itemize}
  \item Reduced the time for manual troubleshooting from half an hour to less than one minute
  \item Provided a general framework for future expansion
\end{itemize}
...
\role{Python}{Team Project\quad Rank $3/160$}
Brief introduction: Fact Extraction and VERification (FEVER), used PyLucene and BERT for the evidence selection and used BERT to classify claims
\begin{itemize}
...
\role{Python}{Team Project\quad Rank $19/156$}
Brief introduction: Used Negamax and alpha-beta pruning to implement a Pacman AI in Pacman Capture the Flag competition
