...
Brief introduction: A fault-tolerant Key/Value service base on Raft algorithm
\begin{itemize}
...
\role{Java/Python}{Supervised by Prof. Tim Miller}
Brief introduction: Use reinforcement learning to generate a deceptive path
\begin{itemize}
  \item Used three dimensions to tag a name
  \item Currently use Stanford NER model to train and test data
\end{itemize}
